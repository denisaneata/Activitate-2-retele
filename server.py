    ...
    try:
        ...
        if comanda == 'CONNECT':
            ...
            if adresa_client not in clienti_conectati:
                ...
                mesaj_id = next_id
                next_id += 1
                mesaje[mesaj_id] = (adresa_client, argumente)
            ...
            if adresa_client not in clienti_conectati:
                ...
                try:
                    ...
                    if mesaj_id not in mesaje:
                        ...
                        autor, _ = mesaje[mesaj_id]
                        if autor != adresa_client:
                            raspuns = "EROARE: Nu esti autorul mesajului."
                        else:
                            del mesaje[mesaj_id]
                            raspuns = "OK: Mesaj sters."
            ...
            if adresa_client not in clienti_conectati:
                ...
                lista = []
                for mid, (_, text) in mesaje.items():
                    lista.append(f"{mid}: {text}")
                raspuns = "\n".join(lista)
